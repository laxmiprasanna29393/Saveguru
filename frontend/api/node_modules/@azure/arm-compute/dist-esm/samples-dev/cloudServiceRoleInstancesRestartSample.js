...
function restartCloudServiceRoleInstance() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudServiceRoleInstances.beginRestartAndWait(roleInstanceName, resourceGroupName, cloudServiceName);
        console.log(result);
    });
}
restartCloudServiceRoleInstance().catch(console.error);
//# sourceMappingURL=cloudServiceRoleInstancesRestartSample.js.map