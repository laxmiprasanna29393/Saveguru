...
function getCloudServiceWithMultipleRolesAndRdpExtension() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudServices.get(resourceGroupName, cloudServiceName);
        console.log(result);
    });
}
getCloudServiceWithMultipleRolesAndRdpExtension().catch(console.error);
//# sourceMappingURL=getCloudServiceWithMultipleRolesAndRdpExtension.js.map