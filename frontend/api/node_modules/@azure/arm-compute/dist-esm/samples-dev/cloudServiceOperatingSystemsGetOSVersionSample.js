 ...
 */
function getCloudServiceOSVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudServiceOperatingSystems.getOSVersion(location, osVersionName);
        console.log(result);
    });
}
getCloudServiceOSVersion().catch(console.error);
//# sourceMappingURL=cloudServiceOperatingSystemsGetOSVersionSample.js.map