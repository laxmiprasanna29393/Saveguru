 ...
 */
function getCloudServiceOSFamily() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudServiceOperatingSystems.getOSFamily(location, osFamilyName);
        console.log(result);
    });
}
getCloudServiceOSFamily().catch(console.error);
//# sourceMappingURL=cloudServiceOperatingSystemsGetOSFamilySample.js.map