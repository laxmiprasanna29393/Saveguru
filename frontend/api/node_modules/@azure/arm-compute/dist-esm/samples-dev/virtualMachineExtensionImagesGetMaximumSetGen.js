...
function virtualMachineExtensionImagesGetMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineExtensionImages.get(location, publisherName, type, version);
        console.log(result);
    });
}
virtualMachineExtensionImagesGetMaximumSetGen().catch(console.error);
//# sourceMappingURL=virtualMachineExtensionImagesGetMaximumSetGen.js.map