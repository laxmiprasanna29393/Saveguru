 ...
 */
function getCloudServiceUpdateDomain() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudServicesUpdateDomain.getUpdateDomain(resourceGroupName, cloudServiceName, updateDomain);
        console.log(result);
    });
}
getCloudServiceUpdateDomain().catch(console.error);
//# sourceMappingURL=cloudServicesUpdateDomainGetUpdateDomainSample.js.map