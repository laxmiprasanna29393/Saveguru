...
function virtualMachineExtensionImagesListVersionsMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineExtensionImages.listVersions(location, publisherName, type);
        console.log(result);
    });
}
virtualMachineExtensionImagesListVersionsMinimumSetGen().catch(console.error);
//# sourceMappingURL=virtualMachineExtensionImagesListVersionsMinimumSetGen.js.map