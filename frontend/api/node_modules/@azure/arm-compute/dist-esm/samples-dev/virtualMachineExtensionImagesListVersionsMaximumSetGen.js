...
function virtualMachineExtensionImagesListVersionsMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineExtensionImages.listVersions(location, publisherName, type, options);
        console.log(result);
    });
}
virtualMachineExtensionImagesListVersionsMaximumSetGen().catch(console.error);
//# sourceMappingURL=virtualMachineExtensionImagesListVersionsMaximumSetGen.js.map