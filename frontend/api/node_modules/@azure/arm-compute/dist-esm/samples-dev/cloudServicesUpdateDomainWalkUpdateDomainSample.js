 ...
 */
function updateCloudServiceToSpecifiedDomain() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudServicesUpdateDomain.beginWalkUpdateDomainAndWait(resourceGroupName, cloudServiceName, updateDomain);
        console.log(result);
    });
}
updateCloudServiceToSpecifiedDomain().catch(console.error);
//# sourceMappingURL=cloudServicesUpdateDomainWalkUpdateDomainSample.js.map