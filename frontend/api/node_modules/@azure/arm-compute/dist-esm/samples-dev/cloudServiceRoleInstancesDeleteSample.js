 ...
 */
function deleteCloudServiceRoleInstance() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudServiceRoleInstances.beginDeleteAndWait(roleInstanceName, resourceGroupName, cloudServiceName);
        console.log(result);
    });
}
deleteCloudServiceRoleInstance().catch(console.error);
//# sourceMappingURL=cloudServiceRoleInstancesDeleteSample.js.map