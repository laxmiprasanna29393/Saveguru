...
function getCloudServiceInstanceViewWithMultipleRoles() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudServices.getInstanceView(resourceGroupName, cloudServiceName);
        console.log(result);
    });
}
getCloudServiceInstanceViewWithMultipleRoles().catch(console.error);
//# sourceMappingURL=getCloudServiceInstanceViewWithMultipleRoles.js.map